...
I LOVE YOU ❤️`LOOKING FORWARD TO SPEND THE REST OF MY LIFE WITH YOU ❤❤ MUAHHH
    }
  ]
};
    ...
    return common + `
      <div class="two-photo">
        ...
        <div class="photo" style="height:72%; width:50%; transform:rotate(3deg)">
          <img src="${escapeHTML(page.photos[0])}" alt="Memory">
  ...
  if (page.type === "collage" || page.type === "photoWall") {
    return common + `
      ...
      <div class="polaroid-grid">
        ${page.photos.slice(0, 6).map((p, i) => imageHTML(p, "", ["one of my favorites", "this day ♡", "look at us", "memory", "you + me", "another one"][i])).join("")}
      </div>
    ...
    return common + `
      ...
      <div style="display:flex;align-items:center;gap:25px;height:78%">
        ...
        <div class="photo" style="position:relative;width:46%;height:85%;transform:rotate(-3deg)">
          <img src="${escapeHTML(page.photo)}" alt="Favorite memory">
          <span class="caption">keep this one ♡</span>
        </div>
      </div>
